...
<nav class="w3-sidenav w3-collapse w3-dark-grey w3-animate-left w3-card-2" style="z-index:3;width:250px;" id="mySidenav">
  ...
  <div class="w3-clear"></div>
    <a href="javascript:void(0);" onclick="w3_close();" class="w3-right w3-hover-none w3-xlarge w3-padding1 w3-hide-large w3-hover-text-teal" title="close menu"><i class="fa fa-times-circle w3-margin"></i></a>
  
  <div style="display: block;" id="admin" class="myMenu w3-animate-opacity">
  <div class="w3-container w3-padding-top">
    <h3 class="w3-animate-left w3-padding">Admin</h3>
  </div>
  ...
  <div class="w3-container">
    <h3 class="w3-animate-left">Manager</h3>
  </div>
  ...
  <div class="w3-container">
    <h3 class="w3-animate-left">TeleCaller</h3>
  </div>
...
<div id="myTop" class="w3-top w3-container w3-padding-16 w3-theme w3-large">
  ...
  <div id="myIntro" class="w3-hide">
    <a href="http://sunoray.com" target="ext" class="navbar-brand logo w3-margin-0 w3-margin-right w3-hover-white w3-animate-zoom"><img src="<?php echo home_url()?>/wp-content/uploads/2016/06/te-favicon.png" width="20px"></a>
...
<header class="w3-container w3-theme w3-padding-64" style="padding-left:32px">
  <a href="http://sunoray.com" target="ext" class="w3-margin-0 w3-hover-none w3-padding w3-margin-right w3-hover-white w3-hover-shadow w3-white w3-round w3-animate-opacity" style="display:block;"><img src="<?php echo home_url()?>/wp-content/uploads/2016/07/Tentacle.png" width="300px"></a>
  <p class="w3-xxlarge w3-margin-top w3-animate-left">Tentacle Documentation</p>
